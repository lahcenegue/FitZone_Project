...
Includes smart routing for base module URLs to prevent 404 errors.
"""
...
def login_redirect_view(request):
    """
    Central router for the portal root ('/portal/').
    Strictly handles Admin ejection and Auth flow.
    """
...
urlpatterns = [
    ...
    # TRAINER MODULE
    # ==========================================================
    path("trainer/", RedirectView.as_view(pattern_name="provider_portal:trainer_profile", permanent=False)),
    ...
    # RESTAURANT MODULE
    # ==========================================================
    path("restaurant/", RedirectView.as_view(pattern_name="provider_portal:restaurant_menu", permanent=False)),
    ...
    # STORE MODULE
    # ==========================================================
    path("store/", RedirectView.as_view(pattern_name="provider_portal:store_products", permanent=False)),
